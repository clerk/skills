/**
 * Custom Sign-In Component Template
 * 
 * Build a completely custom sign-in flow with full control over the UI.
 * Use this when you need a custom design that doesn't fit Clerk's pre-built components.
 */
"use client";
...
export function CustomSignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        // Handle 2FA - redirect to verification
  ...
  const signInWithOAuth = async (provider: "oauth_google" | "oauth_github") => {
    if (!isLoaded) return;
    ...
    <div className="w-full max-w-md mx-auto p-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          ...
          <a href="/sign-up" className="hover:text-blue-600">
            Create an account
          </a>
        </div>
      </div>
