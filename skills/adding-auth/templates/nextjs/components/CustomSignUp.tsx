/**
 * Custom Sign-Up Component Template
 * 
 * Build a completely custom sign-up flow with email verification.
...
export function CustomSignUp() {
  ...
  const signUpWithOAuth = async (provider: "oauth_google" | "oauth_github") => {
    if (!isLoaded) return;
