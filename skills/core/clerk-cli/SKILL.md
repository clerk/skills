...
- **For `init`, follow the generated setup reference.** It owns framework-support, accountless, app-linking, and login-order guidance so those instructions stay synchronized with Clerk's docs prompts.
...
- [references/setup.md](references/setup.md) - generated canonical setup and initialization flow, including auth migration checks.
